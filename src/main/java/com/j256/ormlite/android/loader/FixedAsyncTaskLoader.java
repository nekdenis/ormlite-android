...
/**
 * Abstract Loader that provides an {@link android.os.AsyncTask} to do the work.  See
 ...
 */
public abstract class FixedAsyncTaskLoader<D> extends Loader<D> {
    static final String TAG = "FixedAsyncTaskLoader";
    ...
    final class LoadTask extends AsyncTask<Void, Void, D> implements Runnable {
        ...
        protected D doInBackground(Void... params) {
            ...
            try {
                D data = FixedAsyncTaskLoader.this.onLoadInBackground();
                if (DEBUG) Log.v(TAG, this + "  <<< doInBackground");
                return data;
        ...
        protected void onPostExecute(D data) {
            ...
            try {
                FixedAsyncTaskLoader.this.dispatchOnLoadComplete(this, data);
            } finally {
                mDone.countDown();
            }
        }
        ...
        protected void onCancelled(D data) {
            ...
            try {
                FixedAsyncTaskLoader.this.dispatchOnCancelled(this, data);
            } finally {
                mDone.countDown();
            }
        }
        ...
        public void run() {
            waiting = false;
            FixedAsyncTaskLoader.this.executePendingTask();
        }
    ...
    public FixedAsyncTaskLoader(Context context) {
        ...
        Log.d("DEBUG", "FixedAsyncTaskLoader constructor");
    }

    /** {@hide} */
    public FixedAsyncTaskLoader(Context context, Executor executor) {
        super(context);
        mExecutor = executor;
    }
    ...
    void executePendingTask() {
        if (mCancellingTask == null && mTask != null && mTask.getStatus() == AsyncTask.Status.PENDING) {
            if (mTask.waiting) {
                mTask.waiting = false;
                mHandler.removeCallbacks(mTask);
            }
